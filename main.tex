...
Sections~\ref{sec:regimes}--\ref{sec:reductions}, the second only
...
misaligned part is $q$ and the residue groups are the arithmetic
progressions of positions modulo $q$.  Classes from different
...
Section~\ref{sec:routes} and the block measures of the
excursion remark by the claims script;
