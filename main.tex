...
Appendix~\ref{sec:verification} describes the verification.  We emphasise at the
...
normalised quantity $(R-1)H/4$ falls through 1.1553, 1.1345, 1.1217, 1.1129, 1.1065 toward the
...
take full responsibility for the content.  Every number quoted in the paper that arises from our own
computations is reproduced by a named program of the artifact,
whose recorded outputs it contains.
