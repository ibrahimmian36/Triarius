...
the fifth.  Induced systems arise in two
...
$\sum_j1/n_j$ of them, which is below $\varepsilon_0$ when the
...
position: with $p_j\in\{11,197,439,691,977,1259\}$ the measured
survivor measure is $0.8995$, agreeing with the product to four
...
twice.  The profinite survivor set of $\mathcal{P}$ is $\Ahat$ up
...
diverges by Mertens.  (The cruder bound $s\,P(2)$ alone is not correct: the
...
\path{verify_spike_bound.py} and \path{verify_excursion2.py};
and the coverage table by \path{verify_coverage.py}.  The
